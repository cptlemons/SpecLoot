...
* **Bonus Rolls & Great Vault Tracking:** Check the "Bonus Rolls" mode toggle to view scaled Great Vault item levels and upgrade track badges (e.g., M+ 10 and Heroic Raid display `1/6 Myth`, Mythic Raid displays `6/6 Myth` / `9/6 Myth`). Right-click any item in this mode to mark it as received (applying a strikethrough line and dimming the icon), removing it from your active loot pool per-spec. Mythic+ keystone levels +2 through +9 have independent loot pools while +10 and above share a unified pool. Raid loot pools are isolated per difficulty (LFR, Normal, Heroic, Mythic).
...
* **Tier Token & Omni-Curio Support:** Accurately classifies class tier tokens and omni-curios (*Slumbering Coil Curio*) for applicable specs in Normal Loot mode, while excluding non-rollable curios from Bonus Rolls mode and filtering out cosmetic transmogs, mounts, pets, and fluff.
